...
\begin{enumerate}
    ...
    \draw (7.3,-38.9) node {$0,1,1$};
    \draw [black] (67.3,-38.9) circle (3);
    \draw (67.3,-38.9) node {$1,1,0$};
    \draw [black] (39.2,-50.2) circle (3);
    \draw (39.2,-50.2) node {$1,0,1$};
    \draw [black] (39.2,-23.1) circle (3);
    \draw (39.2,-23.1) node {$0,0,0$};
    \draw [black] (21.2,-23.1) circle (3);
    \draw (21.2,-23.1) node {$1,1,0$};
    \draw [black] (21.2,-12.4) circle (3);
    \draw (21.2,-12.4) node {$1,1,0$};
    \draw [black] (7.3,-4.9) circle (3);
    \draw (7.3,-4.9) node {$1,0,1$};
    \draw (3.8,-4.9) node {$*$};
    \draw [black] (7.3,-23.1) circle (3);
    \draw (7.3,-23.1) node {$1,0,1$};
    \draw [black] (54.5,-12.4) circle (3);
    \draw (54.5,-12.4) node {$0,0,0$};
    \draw [black] (54.5,-28) circle (3);
    \draw (54.5,-28) node {$0,0,0$};
    \draw [black] (67.3,-4.9) circle (3);
    \draw (67.3,-4.9) node {$0,1,1$};
    \draw [black] (67.3,-23.1) circle (3);
    \draw (67.3,-23.1) node {$0,1,1$};
    \draw [red] (10.3,-38.9) -- (64.3,-38.9);
    \fill [red] (64.3,-38.9) -- (63.5,-38.4) -- (63.5,-39.4);
    \draw (37.3,-39.4) node [below] {$b$};
    \draw [red] (64.3,-38.9) -- (10.3,-38.9);
    \fill [red] (10.3,-38.9) -- (11.1,-39.4) -- (11.1,-38.4);
    ...
    \draw [red] (39.2,-47.2) -- (39.2,-26.1);
    \fill [red] (39.2,-26.1) -- (38.7,-26.9) -- (39.7,-26.9);
    \draw (39.7,-36.65) node [right] {$b$};
    \draw [red] (39.2,-26.1) -- (39.2,-47.2);
    \fill [red] (39.2,-47.2) -- (39.7,-46.4) -- (38.7,-46.4);
    \draw [blue] (9.99,-37.57) -- (36.51,-24.43);
    \fill [blue] (36.51,-24.43) -- (35.57,-24.34) -- (36.02,-25.23);
    \draw [green] (64.69,-37.43) -- (41.81,-24.57);
    \fill [green] (41.81,-24.57) -- (42.27,-25.4) -- (42.76,-24.53);
    \draw (54.19,-30.5) node [above] {$c$};
    \draw [red] (18.401,-24.147) arc (318.24444:30.24444:2.25);
    \draw (13.84,-22.33) node [left] {$b$};
    \fill [red] (18.67,-21.52) -- (18.4,-20.61) -- (17.74,-21.36);
    \draw [blue] (22.86,-25.6) -- (37.54,-47.7);
    \fill [blue] (37.54,-47.7) -- (37.51,-46.76) -- (36.68,-47.31);
    \draw [blue] (64.52,-40.02) -- (41.98,-49.08);
    \fill [blue] (41.98,-49.08) -- (42.91,-49.25) -- (42.54,-48.32);
    \draw [green] (10.13,-39.9) -- (36.37,-49.2);
    \fill [green] (36.37,-49.2) -- (35.79,-48.46) -- (35.45,-49.4);
    \draw [red] (24.2,-23.1) -- (36.2,-23.1);
    \fill [red] (36.2,-23.1) -- (35.4,-22.6) -- (35.4,-23.6);
    \draw (30.2,-23.6) node [below] {$b$};
    \draw [red] (9.12,-7.28) -- (19.38,-20.72);
    \fill [red] (19.38,-20.72) -- (19.29,-19.78) -- (18.5,-20.38);
    \draw (14.82,-12.6) node [right] {$b$};
    \draw [red] (21.2,-15.4) -- (21.2,-20.1);
    \fill [red] (21.2,-20.1) -- (21.7,-19.3) -- (20.7,-19.3);
    ...
    \draw [red] (6.542,-25.991) arc (13.03983:-274.96017:2.25);
    \draw (1.86,-28.69) node [below] {$b$};
    \fill [red] (4.54,-24.26) -- (3.65,-23.95) -- (3.88,-24.92);
    \draw [red] (18.82,-14.23) -- (9.68,-21.27);
    \fill [red] (9.68,-21.27) -- (10.62,-21.18) -- (10.01,-20.39);
    \draw (13.24,-17.25) node [above] {$b$};
    \draw [red] (7.3,-7.9) -- (7.3,-20.1);
    \fill [red] (7.3,-20.1) -- (7.8,-19.3) -- (6.8,-19.3);
    \draw (6.8,-14) node [left] {$b$};
    \draw [blue] (64.321,-38.544) arc (-97.20868:-112.29725:213.657);
    \fill [blue] (64.32,-38.54) -- (63.59,-37.95) -- (63.46,-38.94);
    \draw (36.01,-33.75) node [below] {$a$};
    \draw [green] (7.3,-26.1) -- (7.3,-35.9);
    \fill [green] (7.3,-35.9) -- (7.8,-35.1) -- (6.8,-35.1);
    \draw (6.8,-31) node [left] {$c$};
    \draw [red] (51.514,-28.126) arc (300.14714:12.14714:2.25);
    \draw (47.6,-24.28) node [left] {$b$};
    \fill [red] (52.58,-25.71) -- (52.61,-24.76) -- (51.75,-25.27);
    \draw [red] (70.2,-23.821) arc (103.76817:-184.23183:2.25);
    \draw (73,-28.9) node [right] {$b$};
    \fill [red] (68.49,-25.84) -- (68.2,-26.74) -- (69.17,-26.5);
    ...
    \draw [green] (56.78,-29.95) -- (65.02,-36.95);
    \fill [green] (65.02,-36.95) -- (64.73,-36.06) -- (64.08,-36.82);
    \draw (61.85,-32.96) node [above] {$c$};
    \draw [blue] (51.58,-28.68) -- (10.22,-38.22);
    \fill [blue] (10.22,-38.22) -- (11.12,-38.53) -- (10.89,-37.56);
    \draw (30.27,-32.88) node [above] {$a$};
    \draw [yellow] (64.3,-23.1) -- (42.2,-23.1);
    ...
    \draw [red] (67.3,-7.9) -- (67.3,-20.1);
    \fill [red] (67.3,-20.1) -- (67.8,-19.3) -- (66.8,-19.3);
    \draw (66.8,-14) node [left] {$b$};
    \draw [red] (65.85,-7.52) -- (55.95,-25.38);
    \fill [red] (55.95,-25.38) -- (56.78,-24.92) -- (55.9,-24.43);
    \draw (61.57,-17.65) node [right] {$b$};
    \draw [red] (56.8,-14.32) -- (65,-21.18);
    \fill [red] (65,-21.18) -- (64.71,-20.28) -- (64.06,-21.05);
    \draw (59.89,-18.24) node [below] {$b$};
    \draw [red] (24.2,-12.4) -- (51.5,-12.4);
